...
const dLEverything = __importStar(require("./scraper"));
const mainNodeDataInsert_1 = __importDefault(require("./mainNodeDataInsert"));
const path = __importStar(require("path"));
const inserter = new mainNodeDataInsert_1.default();
